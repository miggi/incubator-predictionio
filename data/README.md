...
```
$ sbt/sbt "data/run-main org.apache.predictionio.storage.hbase.upgrade.CheckDistribution <new_app_id>"
```
...
```
$ sbt/sbt "data/run-main org.apache.predictionio.storage.hbase.upgrade.Upgrade_0_8_3 <old_app_id> <new_app_id>"
... Done.
```
