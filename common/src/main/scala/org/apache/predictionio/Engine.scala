...
import org.apache.predictionio.EngineManifest
import org.apache.predictionio.EngineManifestSerializer
import org.apache.predictionio.tools._
import org.apache.predictionio.ReturnTypes._
import org.apache.predictionio.Common._
...
object Engine extends EitherLogging {
  ...
  private def withRegisteredManifest[T](ea: EngineArgs)(
    ...
    val res: Expected[Expected[T]] = for {
      ...
      manifest <- Storage.getMetaDataEngineManifests.get(id, version)
        .toRight {
          val errStr =
  ...
  def run(
    ...
    val extraFiles = thirdPartyConfFiles
