...
package org.apache.predictionio.storage

import org.apache.predictionio.annotation.DeveloperApi
import org.joda.time.DateTime

/** :: DeveloperApi ::
  * Provides aggregation support of Events to LEvents. Engine developers
  * should use org.apache.predictionio.store.LEventStore instead of using this
  * directly.
  *
  * @group Event Data
  */
...
object LEventAggregator {
  /** :: DeveloperApi ::
    ...
    * Events with the latest property values from all Events, and their
    * first and last updated time
    *
    * @param events An iterator of Events whose properties will be aggregated
